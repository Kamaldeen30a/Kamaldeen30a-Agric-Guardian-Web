...
export const Footer = () => {
  return (
    <footer className="bg-slate-900 pt-12 sm:pt-16 pb-6 sm:pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-12 pb-8 sm:pb-12 border-b border-slate-800">
          {/* Brand */}
          <div className="col-span-2 lg:col-span-2">
            <a href="#" className="flex items-center gap-2 mb-4">
              <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-lg sm:rounded-xl bg-emerald-500 flex items-center justify-center">
                <Leaf className="w-5 sm:w-6 h-5 sm:h-6 text-white" />
              </div>
              <span className="font-display font-bold text-lg sm:text-xl text-white">
                Agri-Guardian <span className="text-emerald-400">Web</span>
              </span>
            </a>
            <p className="text-sm sm:text-base text-slate-400 leading-relaxed max-w-sm">
              The enterprise command center for modern agriculture. Data-driven decisions for large-scale farm operations.
            </p>
          </div>
        ...
        <div className="pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-xs sm:text-sm text-center sm:text-left">
            © {new Date().getFullYear()} Agri-Guardian Web. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <a 
              href="https://x.com/IssaKamaldeen7" 
              target="_blank" 
            ...
            <a 
              href="https://www.linkedin.com/in/issa-kamaldeen" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-slate-400 hover:text-emerald-400 transition-colors"
            >
            ...
            <a 
              href="https://github.com/Kamaldeen30a/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-slate-400 hover:text-emerald-400 transition-colors"
            >
